...
const BestSellers = () => {
  ...
  const [mainCategory, setMainCategory] = useState([]); // Added main category state
  ...
  // Added wishlist toggle function
  ...
  const applyFilter = () => {
    ...
    // Apply main category filter (Men, Women, Kids)
  ...
  return (
    <div className='flex flex-col sm:flex-row pt-10 min-h-screen mt-[81px]'>

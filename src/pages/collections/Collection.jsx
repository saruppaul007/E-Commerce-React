...
const Collection = () => {
  ...
  // Initialize filterProducts with all products on first load
  useEffect(() => {
  ...
  // Set displayProducts to filterProducts initially
  useEffect(() => {
  ...
  return (
    <div className='flex flex-col sm:flex-row pt-10 min-h-screen mt-[60px]'>
      {/* Filter Component - Sticky sidebar with proper height */}
      ...
      {/* Main Collection Component - Now takes remaining space */}

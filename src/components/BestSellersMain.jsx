...
import ProductSort from './collections/ProductSort';

const BestSellersMain = ({ 
  filterProducts, 
  displayProducts, 
      ...
      <PageSection className='min-h-screen'>
        ...
        {displayProducts.length === 0 && (
          <div className='text-center py-16'>
            <p className='text-gray-500 text-lg instrument-sans-regular'>No bestselling products found matching your filters.</p>
            <button 
...
export default BestSellersMain;